...
def detect_aruco_image():
    ...
    template_image = './datasets/InitialDataset/templates/template2_fewArucos.png'
    input_image_raw = './datasets/InitialDataset/templates/real_image_12.png'
...
def detect_live_image_aruco(h_points_template_image, h_points_input_image, h_points_input_image_estimation):

    #camera = cv2.VideoCapture(0)
    camera = cv2.VideoCapture('./datasets/InitialDataset/FewArucos-Viewpoint2.mp4')
    template_image = './datasets/InitialDataset/templates/template2_fewArucos.png'
    ...
    while True:
        ...
        if ids is not None and len(ids) == 4:
            ...
            for i in range(len(ids)):
                for j in range (len(ids)):
                    ...
                    print('[', corners[i][0][j,0], ' ', corners[i][0][j,1], ' ', ids[i][0], ']')
        ...
        if ids is not None and len(ids) < 4:
            h_points_input_image_estimation = []
            for i in range(len(ids)):
                for j in range (4):
                    h_points_input_image_estimation.append([(corners[i][0][j,0],corners[i][0][j,1]), ids[i][0]])
                    print('[', corners[i][0][j,0], ' ', corners[i][0][j,1], ' ', ids[i][0], ']')
        ...
        # print("h_points_template_image: {}".format(h_points_template_image)) 
        h_points_input_image_sorted = sorted(h_points_input_image, key=lambda x: x[1])
        h_points_input_image_estimation_sorted = sorted(h_points_input_image_estimation, key=lambda x: x[1])
        h_points_template_image_sorted = sorted(h_points_template_image, key=lambda x: x[1])
        # print("h_points_input_image sorted: {}".format(h_points_input_image_sorted)) 
        # print("h_points_template_image sorted: {}".format( h_points_template_image_sorted))
        ...
        if len(ids) < 4:
            counter = 0
            for elem in h_points_input_image_estimation_sorted:
                print(elem)
                print(elem[1])
                if elem[1] == 0:
                    h_points_input_image_sorted[counter] = elem
                    counter += 1
                    if counter == 4:
                        counter = 0
                if elem[1] == 1:
                    h_points_input_image_sorted[counter + 4] = elem
                    counter += 1
                    if counter == 4:
                        counter = 0
                if elem[1] == 2:
                    h_points_input_image_sorted[counter + 8] = elem
                    counter += 1
                    if counter == 4:
                        counter = 0
                if elem[1] == 3:
                    h_points_input_image_sorted[counter + 12] = elem
                    counter += 1
                    if counter == 4:
                        counter = 0

        print('FULL POS: ', h_points_input_image_sorted)
        print('NEW POS: ', h_points_input_image_estimation_sorted)
    
        if len(h_points_input_image_sorted)==len(h_points_template_image_sorted):
...
template_image = cv2.imread('./datasets/InitialDataset/templates/template2_fewArucos.png',0)
...
if CAMERA_MODE == 1:
    source_img = detect_live_image_aruco(h_points_template_image, h_points_input_image, h_points_input_image_estimation)
elif CAMERA_MODE == 2:
    source_img ='./datasets/InitialDataset/templates/real_image_12.png'
